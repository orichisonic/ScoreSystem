...
<div id="divIframe" title="业绩明细">
    ...
    <legend><% =account.AREANAME+"办事处其他推广业绩明细"%></legend>
             ...
             %>
                    <tr>
                        ...
                        <td  style="border: 1px solid #000000;height: 21px; text-align:center; vertical-align:middle;color: #000000; font-size: 14px;  width: 40px;  border-style:ridge;border-width: 1px;text-align: center;font-size:small;">
                            ...
                            <td  style="border: 1px solid #000000;height: 21px; text-align:center; vertical-align:middle;color: #000000; font-size: 14px;  width: 40px;  border-style:ridge;border-width: 1px;text-align: center;font-size:small;">
                            <a href="<%=rows.POPEDOMID%>,<%=rows.UKEY%>"><%=rows.USERNAME %></a></td>
                        <td  style="border: 1px solid #000000;height: 21px; text-align:center; vertical-align:middle;color: #000000; font-size: 14px;  width: 40px;  border-style:ridge;border-width: 1px;text-align: center;font-size:small;">
                            <%=rows.UACCOUNT%>
                        </td>
                            <td  style="border: 1px solid #000000;height: 21px; text-align:center; vertical-align:middle;color: #000000; font-size: 14px;  width: 40px;  border-style:ridge;border-width: 1px;text-align: center;font-size:small;">
      ...
      <%} %>
       <table width="100%"></table>
        <center style="margin-top:6px">
            ...
            <button class="ui-state-default ui-corner-all" type="button" onclick="ReturnPrevious()">返回</button>
        </center>               
        </div>
    </div>
 </div>
  ...
  $(document).ready(function() {
     ...
     function loadData(index) {
             ...
             if (actionString == undefined || actionString == "undefined" || actionString == "") {
              ...
              //var define = $("#Gclass option:selected").val()0
              var beginTime = $("#startt").html();
              var endTime = $("#endt").html();
              ...
              var str = "http://" + location.host + "/ScoreOffice.aspx/OfficeOtherDetailInfo2/" + sP641;
          ...
          function loadData2(index) {
              ...
              var str = "http://" + location.host + "/ScoreOffice.aspx/OfficeOtherDetailInfo2/" + sP642;
              location.replace(str);
          }
