...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div style="color:Blue">查询总计:<span id="totalsum"></span></div>
    ...
    <button  style=" display:none;margin-left:20px; vertical-align:bottom" class="ui-state-default ui-corner-all" type="button" onclick="loadexcelall()" id="excelall">导出全部数据(数据量较大时请耐心等待)</button></div>
    <script type="text/javascript">
        ...
        function loadData(index) {
            ...
            //alert(tabsIndex);
            if (index == 0) {
                //alert(index + ";" + areaID + ";" + beginTime + ";" + endTime + ";" + account + ";" + searchtype);
