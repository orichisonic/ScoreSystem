  ...
  <div style="color:Blue">查询总计:<span id="totalsum"></span></div>
    <div id="tabs">
        <ul>
            ...
            <li><a href="#tabs2" id="ysh">游离</a></li>
    ...
    <div id="loadallexcel" >
        ...
        <button style="margin-left:20px; vertical-align:bottom" class="ui-state-default ui-corner-all" type="button" onclick="loadnetbarInfo()" id="excelnetbar">导出网吧数据(由于网吧数据量大请耐心等待)</button>
    </div>
    ...
    $(document).ready(function() {
        ...
        if (power == 1 || power == 2 || power == 3 || power == 4 || power == 99) {
            $('#excelnow').show();
            $('#excelbs').show();
            $('#excelone').show();
            $('#excelnetbar').show();
