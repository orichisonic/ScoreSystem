   ...
   <%
    ...
    <fieldset>
        ...
        <ul class="verticality">
            ...
            <li>现锁定人:&nbsp;<span id="lockaccount"><%=condtion.LOCKACCOUNT%></span></li>
            <li>锁定时间:&nbsp;<span id="lockTime"><%=condtion.LOCKTIME %></span></li>
...
//            oriID = oriID + ",";
        ...
        function updateStatus() {
            ...
            url = "http://" + location.host + "/NetBarBindAndLock.aspx/NetBarUnlock/";
            $.ajax({
            //                url: 'NetBarUnlock/',
                url:url,
                dataType: 'json',
