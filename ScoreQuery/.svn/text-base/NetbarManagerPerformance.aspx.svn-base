    ...
    <span id="power">
        ...
        <span id="ukey">
            ...
            if (condtion != null)
            {
                ...
                //if (condtion.START.ToShortDateString()=="0001-1-1")
                //{
                ...
                //if (condtion.END.ToShortDateString() == "0001-1-1")
                //{
          ...
          <ul class="verticality">
           <li style=" vertical-align:bottom">
            <input name="rd1" type="radio" value="1" checked="checked"/>
             ...
             <input type="text" name="beginTime" id="beginTime" style="width: 90px; vertical-align:bottom; margin-left:1px" onfocus="setday(this)" value="2010-1-1"/>
             结束日期 
             <input type="text" name="endTime" id="endTime" style="width: 90px; vertical-align:bottom" onfocus="setday(this)" value="<%= DateTime.Now.ToShortDateString() %>"/>
            </li>
           </ul>
           <ul class="verticality">
            <li style="vertical-align:bottom">
             <input name="rd1" type="radio" value="0"/>
              按月份查询（每月25日起可查询当月数据） 
            ...
            <ul class="verticality">
                ...
                <%--<select name="class" id="class" style="width:226px">
                    <option value="0" >所有游戏</option>
                    <%
                        List<TGProject.Models.WModels.TGSDEFINESHOW> DefineList = (List<TGProject.Models.WModels.TGSDEFINESHOW>)ViewData["Define"];
                        foreach (TGProject.Models.WModels.TGSDEFINESHOW define in DefineList)
                ...
                <button id="btn1"  style="margin-left:63px; vertical-align:bottom" class="ui-state-default ui-corner-all" type="button" onclick="loadNetbarManagerPerformance()">查询</button>
                </li>
            </ul>
               </fieldset> 
                <div id="tabs" style="vertical-align:top">
        <ul>
  ...
  <div id="tabs-1" style="vertical-align: top; text-align: left">  
        ...
        <table cellpadding="0" cellspacing="0" border="0" 
          ...
          <tr style="background-color:#FFFFFF; font-weight:bold">
           ...
           直接推广</td>
           <td colspan="2" 
            style="border: 1px inset #000000; height: 21px;text-align:center; vertical-align:middle;color: #000000; font-size: 14px;   text-align: center;font-size:small;">
           间接推广</td>
           <td colspan="6" 
            style="border: 1px solid #000000;height: 21px;text-align:center; vertical-align:middle;color: #000000; font-size: 14px;   text-align: center;font-size:small;">
           其他推广</td>
...
<%--        <tr>
        ...
        <td style="border: 1px solid #000000"></td>
        <td style="border: 1px solid #000000"></td>
        <td style="border: 1px solid #000000"><a href="TGPerformanceDetailInfo">彭</a></td>
        </tr>--%>
...
<table width="100%"></table>
    <center style="margin-top:10px"><button class="ui-state-default ui-corner-all" type="button" onclick="QueryDetail()">
                       查看详细</button>        
                        <button style="margin-left:10px" class="ui-state-default ui-corner-all" type="button" onclick="ReturnPrevious()">
                       返回</button></center> 
                                 </div>        
    </div>
   </div>
 ...
 <script type="text/javascript">
     ...
     $(document).ready(function() {
         ...
         if (power != 6) {
             ...
             //如果不是网吧主管登陆就是办事处传过来的UKEY，那就替换掉原来的UKEY进行查询操作
         }
     ...
     function loadNetbarManagerPerformance() {
         var datedemo = /((^((1[8-9]\d{2})|([2-9]\d{3}))([-\/\._])(10|12|0?[13578])([-\/\._])(3[01]|[12][0-9]|0?[1-9])$)|(^((1[8-9]\d{2})|([2-9]\d{3}))([-\/\._])(11|0?[469])([-\/\._])(30|[12][0-9]|0?[1-9])$)|(^((1[8-9]\d{2})|([2-9]\d{3}))([-\/\._])(0?2)([-\/\._])(2[0-8]|1[0-9]|0?[1-9])$)|(^([2468][048]00)([-\/\._])(0?2)([-\/\._])(29)$)|(^([3579][26]00)([-\/\._])(0?2)([-\/\._])(29)$)|(^([1][89][0][48])([-\/\._])(0?2)([-\/\._])(29)$)|(^([2-9][0-9][0][48])([-\/\._])(0?2)([-\/\._])(29)$)|(^([1][89][2468][048])([-\/\._])(0?2)([-\/\._])(29)$)|(^([2-9][0-9][2468][048])([-\/\._])(0?2)([-\/\._])(29)$)|(^([1][89][13579][26])([-\/\._])(0?2)([-\/\._])(29)$)|(^([2-9][0-9][13579][26])([-\/\._])(0?2)([-\/\._])(29)$))/;
            ...
            if ($("#frm1 input[type *= 'radio'][checked]").val() == 1) {
                ...
                str = "http://" + location.host + "/ScoreQuery.aspx/LoadNetbarManagerPerformanceInfo/" + parm643;
                ...
                var parm644 = BASE64.encode(pram);
                str = "http://" + location.host + "/ScoreQuery.aspx/LoadNetbarManagerPerformanceInfo/" + parm644;
                location.replace(str);
            }
         }
         function QueryDetail() {
             ...
             if ($("#frm1 input[type *= 'radio'][checked]").val() == 1) {
                 ...
                 var parm641 = BASE64.encode(pram);
                 str = "http://" + location.host + "/ScoreQuery.aspx/LoadNetbarManagerPerformanceDetailInfo/" + parm641;
                 location.reload(str);
                 ...
                 str = "http://" + location.host + "/ScoreQuery.aspx/LoadNetbarManagerPerformanceDetailInfo/" + parm642;
                 location.reload(str);
             }
