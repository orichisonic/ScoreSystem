...
<table width="90%" id="general-table" align="center">
  ...
  <tr>
	...
	<td>
	    <%=Html.TextBox("ACTIVENAME", "", new { maxlength = 50 })%>
  ...
  <tr>
  	...
  	<td>
  	<%=Html.TextBox("ACTIVEDATE", "", new { maxlength = 50 })%>
  ...
  <tr>
  	...
  	<td>
  	 <%=Html.TextBox("ACTIVEENDDATE", "", new { maxlength = 50 })%>
   ...
   <tr>
  	...
  	<td>
  	<%=Html.TextBox("AWARD", "0", new { maxlength = 5 })%> 积分
  ...
  <tr>
  	...
  	<td>
  	<%=Html.TextArea("ACTIVEDESC", "", new { rows=5 })%>
  ...
  <tr>
  	...
  	<td>
  	<%=Html.TextBox("LINK", "", new { maxlength = 100 })%>
  ...
  <tr>
  	...
  	<td>
  	   <%=Html.RadioButton("STATE", 1, false)%> 直接激活
  	   <%=Html.RadioButton("STATE", 0, true)%> 不激活
  	</td>
