    ...
    <fieldset>
        ...
        <div style="text-align: left">
            <ul class="verticality"  id="by_day_id">
             ...
             <input style="vertical-align:bottom" type="text" name="beginTime" id="beginTime" style="width: 90px" onfocus="setday(this)" value="2009-9-1"/>
...
<script type="text/javascript">
    ...
    //////////////////////////////////////
        ...
        mygrid = $("#list").jqGrid({
            width: 750,
            height: 400,
            url: 'http://' + location.host + '/ScoreParttime.aspx/PartTimeScore/',
            datatype: 'json',
            mtype: 'POST',
            pager: '#pager',
            rowNum: 40,
            ...
            recordtext: '条记录',
            loadtext: '加载数据请稍候..',
            colNames: ['大区', '办事处', '推荐人', '职务', '姓名', '帐号', '领取数', '消费用户数', '消费金额', '消费转换率', '有效用户数', '有效转换率', '业绩', '小组排名', '总排名'],
            ...
            colModel: [{ name: 'zonename', index: 'ZONENAME', width: 70, align: 'center' },
                                        ...
                                        { name: 'popedomname', index: 'POPEDOMNAME', width: 70, align: 'center' },
                                        { name: 'username', index: 'USERNAME', width: 70, align: 'center' },
                                        { name: 'uaccount', index: 'UACCOUNT', width: 70, align: 'center' },
                                        { name: 'getnum', index: 'GETNUM', width: 150, align: 'center' },
                                        { name: 'consnum', index: 'CONSNUM', width: 160, align: 'center' },
                                        { name: 'conssum', index: 'CONSSUM', width: 140, align: 'center' },
                                        { name: 'consconv', index: 'CONSCONV', width: 140, align: 'center' },
                                        { name: 'availnum', index: 'AVAILNUM', width: 140, align: 'center' },
                                        { name: 'availconv', index: 'AVAILCONV', width: 140, align: 'center' },
                                        { name: 'outachive', index: 'OUTACHIVE', width: 70, align: 'center' },
                                        { name: 'grouporder', index: 'GROUPORDER', width: 70, align: 'center' },
    ...
    function loadData() {
        ...
        if ($("#frm1 input[type *= 'radio'][checked]").val() == 1) {
            ...
            mygrid.appendPostData({ DEFINEID: defineID, UKEY: ukey, START: beginTime, END: endTime, AREAID: areaId });
            ...
            DefineID = newdefineid;
            mygrid.appendPostData({ DEFINEID: defineID, UKEY: ukey, START: beginTime, END: endTime, AREAID: areaId, bymonth: bymonth });
            mygrid.trigger('reloadGrid');
        }
    }
    ...
    function QueryDetail() {
        ...
        str = "http://" + location.host + "/ScoreParttime.aspx/LoadPartTimeScoreDetail/" + parm64;
        //alert(DefineID);
        location.reload(str);
