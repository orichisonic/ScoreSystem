...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <%
            ...
            {
                selectIdx = 0;
                dteBegin = Convert.ToDateTime("2009-9-2");
 ...
 <%--<asp:ScriptManager ID="ScriptManager1" runat="server"
    ...
    <div><span>推广中心共发展兼职推广员</span><span id="parternum"></span><span>名</span></div>
    <div>
   <form>
     <fieldset>
 ...
 <script type="text/javascript">
     ...
     $(document).ready(function() {
         ...
         mygrid = $("#list").jqGrid({
             ...
             colNames: ['兼职推广员人数', '领取数', '消费用户数', '消费金额', '消费转换率', '有效用户数', '有效转换率', '业绩'],
             colModel: [{ name: 'PTNUM', index: 'PTNUM', width: 90, align: 'center' },
...
//             //活动id,开始时间,结束时间,下拉框选择index,排序,大区id,按月查找的日期,大区经理ukey,分类按钮的index
//             // str = "http://" + location.host + "/ScoreOffice.aspx/OfficeLstInfo/" + define + "," + beginTime + "," + endTime + ',' + selectindex + "," + 1 + "," + $("#areaid").html() + "," + "" + "," + "" + "," + defineIndex;
//             str = "http://" + location.host + "/ScoreParttime.aspx/CenterParterQueryDetail";
//             location.replace(str);
