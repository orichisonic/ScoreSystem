...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <%--<asp:ScriptManager ID="ScriptManager1" runat="server"
    ...
    <div><span id="regionname"></span><span>共发展兼职推广员</span><span id="parternum"></span><span>名</span></div>
    <form>
     <fieldset>
...
<br />
           ...
           <div id="tabs">
        <ul>
            <li><a href="#tabs1">兼职推广员业绩查询</a></li>
        </ul>
 ...
 <script type="text/javascript">
     ...
     $(document).ready(function() {
         ...
         mygrid = $("#list").jqGrid({
             ...
             colNames: ['大区', '经理', '兼职推广员人数', '领取数', '消费用户数', '消费金额', '消费转换率', '有效用户数', '有效转换率', '业绩'],
             colModel: [
                         { name: 'ZONENAME', index: 'ZONENAME', width: 90, align: 'center' },
                         { name: 'USERNAME', index: 'USERNAME', width: 80, align: 'center' },
                         { name: 'PTNUM', index: 'PTNUM', width: 90, align: 'center' },
                         { name: 'GETNUM', index: 'GETNUM', width: 80, align: 'center' },
                         { name: 'CONSNUM', index: 'CONSNUM', width: 80, align: 'center' },
                         { name: 'CONSSUM', index: 'CONSSUM', width: 60, align: 'center' },
                         { name: 'CONSCONV', index: 'CONSCONV', width: 60, align: 'center' },
                         { name: 'AVAILNUM', index: 'AVAILNUM', width: 60, align: 'center' },
                         { name: 'AVAILCONV', index: 'AVAILCONV', width: 60, align: 'center' },
                         { name: 'OUTACHIVE', index: 'OUTACHIVE', width: 60, align: 'center' },
     ...
     function loaddata() {
         ...
         var DefineID = 0;
         var OrderKind = 0;
         mygrid.appendPostData({ areaID: areaID == 0 ? 1 : areaID, DefineID: DefineID, v_Type: Type, OrderKind: OrderKind, beginTime: beginTime, endTime: endTime });
     ...
     function LoadContent() {
         ...
         if ($("#frm1 input[type *= 'radio'][checked]").val() == 1) {
             ...
             str = "http://" + location.host + "/ScoreParttime.aspx/ReginParterQuery";
...
//             //活动id,开始时间,结束时间,下拉框选择index,排序,大区id,按月查找的日期,大区经理ukey,分类按钮的index
//             // str = "http://" + location.host + "/ScoreOffice.aspx/OfficeLstInfo/" + define + "," + beginTime + "," + endTime + ',' + selectindex + "," + 1 + "," + $("#areaid").html() + "," + "" + "," + "" + "," + defineIndex;
//             str = "http://" + location.host + "/ScoreParttime.aspx/ReginParterQueryDetail";
//             location.replace(str);
